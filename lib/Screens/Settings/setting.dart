...
class _SettingPageState extends State<SettingPage> {
  ...
  String downloadPath = Hive.box('settings').get('downloadPath', defaultValue: '/storage/emulated/0/Music') as String;
  List dirPaths = Hive.box('settings').get('searchPaths', defaultValue: []) as List;
  String streamingQuality = Hive.box('settings').get('streamingQuality', defaultValue: '96 kbps') as String;
  String downloadQuality = Hive.box('settings').get('downloadQuality', defaultValue: '320 kbps') as String;
  String canvasColor = Hive.box('settings').get('canvasColor', defaultValue: 'Grey') as String;
  String cardColor = Hive.box('settings').get('cardColor', defaultValue: 'Grey850') as String;
  ...
  String themeColor = Hive.box('settings').get('themeColor', defaultValue: 'Teal') as String;
  int colorHue = Hive.box('settings').get('colorHue', defaultValue: 400) as int;
  List<String> languages = ['Hindi', 'English', 'Punjabi', 'Tamil', 'Telugu', 'Marathi', 'Gujarati', 'Bengali', 'Kannada', 'Bhojpuri', 'Malayalam', 'Urdu', 'Haryanvi', 'Rajasthani', 'Odia', 'Assamese'];
  List preferredLanguage = Hive.box('settings').get('preferredLanguage', defaultValue: ['Hindi'])?.toList() as List;
    ...
    return Scaffold(
      ...
      body: CustomScrollView(physics: const BouncingScrollPhysics(), slivers: [
        SliverAppBar(
          ...
          stretch: true,
          pinned: true,
          backgroundColor: Theme.of(context).brightness == Brightness.light ? Theme.of(context).accentColor : null,
                                            ...
                                            for (int hue in [100, 200, 400, 700])
                                              GestureDetector(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      borderRadius: BorderRadius.circular(100.0),
                                                      color: MyTheme().getColor(colors[index], hue),
                                                      boxShadow: [
                                                        BoxShadow(
                                                          color: Colors.grey[900]!,
                                                          blurRadius: 5.0,
                                                    ...
                                                    child: (themeColor == colors[index] && colorHue == hue) ? const Icon(Icons.done_rounded) : const SizedBox(),
                                                  )),
                                          ],
                                        ),
                                      );
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              subtitle: const Text('Gradient used as background everywhere'),
                              trailing: Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Container(
                                  height: 25,
                                            ...
                                            return Padding(
                                              ...
                                              child: GestureDetector(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: (currentTheme.getBackGradient() == gradients[index]) ? const Icon(Icons.done_rounded) : const SizedBox(),
                                                  )),
                                            );
                                          }),
                                    );
                                            ...
                                            return Padding(
                                              ...
                                              child: GestureDetector(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: (currentTheme.getCardGradient() == gradients[index]) ? const Icon(Icons.done_rounded) : const SizedBox(),
                                                  )),
                                            );
                                          }),
                                    );
                            ...
                            ListTile(
                              ...
                              subtitle: const Text('Gradient used in Bottom Sheets'),
                              trailing: Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Container(
                                  height: 25,
                                            ...
                                            return Padding(
                                              ...
                                              child: GestureDetector(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: (currentTheme.getBottomGradient() == gradients[index]) ? const Icon(Icons.done_rounded) : const SizedBox(),
                                                  )),
                                            );
                                          }),
                                    );
                            ...
                            ListTile(
                              ...
                              trailing: DropdownButton(
                                ...
                                items: <String>['Grey', 'Black'].map<DropdownMenuItem<String>>((String value) {
                            ...
                            ListTile(
                              ...
                              subtitle: const Text('Color of Search Bar, Alert Dialogs, Cards'),
                              onTap: () {},
                              trailing: DropdownButton(
                                value: cardColor,
                                style: TextStyle(
                                ...
                                items: <String>['Grey800', 'Grey850', 'Grey900', 'Black'].map<DropdownMenuItem<String>>((String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
                                  );
                  ...
                  child: Column(
                    children: [
                        ...
                        onTap: () {
                          showModalBottomSheet(
                              ...
                              builder: (BuildContext context) {
                                ...
                                return StatefulBuilder(builder: (BuildContext context, StateSetter setStt) {
                                  return BottomGradientContainer(
                                    borderRadius: BorderRadius.circular(20.0),
                                    child: Column(
                                      children: [
                      ...
                      ListTile(
                          ...
                          subtitle: const Text('Country for Top Spotify Local Charts'),
                          trailing: SizedBox(
                            width: 150,
                            child: Text(
                              region,
                      ...
                      ListTile(
                        ...
                        trailing: DropdownButton(
                          ...
                          items: <String>['96 kbps', '160 kbps', '320 kbps'].map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                            );
                      ...
                      const BoxSwitchTile(
                        ...
                        subtitle: Text('Keep the same repeat option for every session'),
                        keyName: 'enforceRepeat',
                        defaultValue: false,
                      ),
                      ListTile(
                          title: const Text('Search Location'),
                          subtitle: const Text('Locations to search for offline music'),
                          dense: true,
                          onTap: () {
                                      ...
                                      itemBuilder: (cntxt, idx, animation) {
                                        return (idx == 0)
                                            ? ListTile(
                                                ...
                                                onTap: () async {
                                                  final String temp = await Picker().selectFolder(context, 'Select Folder');
                                                  if (temp.trim() != '' && !dirPaths.contains(temp)) {
                                                    dirPaths.add(temp);
                                                    Hive.box('settings').put('searchPaths', dirPaths);
                                                    _listKey.currentState!.insertItem(dirPaths.length);
                                                  } else {
                                                    if (temp.trim() == '') {
                                                      Navigator.pop(context);
                                                    }
                                                    ShowSnackBar().showSnackBar(
                                                      context,
                                                      temp.trim() == '' ? 'No folder selected' : 'Already added',
                                                    );
                                                  }
                                                },
                                              )
                                            : SizeTransition(
                                                ...
                                                child: ListTile(
                                                  ...
                                                  title: Text(dirPaths[idx - 1].toString()),
                                                  trailing: IconButton(
                                                    icon: const Icon(
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      Hive.box('settings').put('searchPaths', dirPaths);
                                                      _listKey.currentState!.removeItem(idx, (context, animation) => Container());
                                                      // setStt(() {});
                                                    },
                                                  ),
                                                ),
                ...
                child: GradientCard(
                  child: Column(children: [
                    ListTile(
                      ...
                      subtitle: const Text('Higher quality uses more disk space'),
                      onTap: () {},
                      trailing: DropdownButton(
                    ...
                    ListTile(
                      ...
                      trailing: TextButton(
                        style: TextButton.styleFrom(
                          primary: Theme.of(context).brightness == Brightness.dark ? Colors.white : Colors.grey[700],
                          //       backgroundColor: Theme.of(context).accentColor,
                        ),
                        onPressed: () async {
                          downloadPath = await ExtStorage.getExternalStoragePublicDirectory(ExtStorage.DIRECTORY_MUSIC) ?? '/storage/emulated/0/Music';
                      ...
                      onTap: () async {
                        final String temp = await Picker().selectFolder(context, 'Select Download Location');
                        if (temp.trim() != '') {
                          downloadPath = temp;
                    ...
                    const BoxSwitchTile(
                      title: Text('Create folder for Album & Playlist Download'),
                      subtitle: Text('Creates common folder for Songs when Album or Playlist is downloaded'),
                    ...
                    const BoxSwitchTile(
                      ...
                      subtitle: Text('Creates a different folder for Songs downloaded from YouTube'),
                ...
                child: GradientCard(
                  child: Column(children: [
                    ListTile(
                        ...
                        subtitle: const Text('Files with size lesser than this will not be shown in music list'),
                        dense: true,
                        onTap: () {
                          TextInputDialog().showTextInputDialog(context, 'Min File Size (in KB)', (Hive.box('settings').get('minSize', defaultValue: 1024) as int).toString(), TextInputType.number, (String value) {
                            Hive.box('settings').put('minSize', int.parse(value));
                            Navigator.pop(context);
                          });
                        }),
                    const BoxSwitchTile(
                      title: Text('Support Equalizer'),
                      subtitle: Text('Turn this off if you are unable to play songs (in both online and offline mode)'),
                      keyName: 'supportEq',
                      isThreeLine: true,
                      defaultValue: true,
                    ),
                    ...
                    const BoxSwitchTile(
                      ...
                      subtitle: Text("If turned off, music won't stop even after app close until you press stop button\nDefault: On\n"),
                      isThreeLine: true,
                    ...
                    const BoxSwitchTile(
                      ...
                      subtitle: Text("If turned on, you can slide notification when paused to stop the service. But Service can also be stopped by android to release memory. If you don't want android to stop service while paused, turn it off\nDefault: On\n"),
                      isThreeLine: true,
                    ...
                    const BoxSwitchTile(
                      ...
                      subtitle: Text("If you download BlackHole from any software repository like 'F-Droid', 'IzzyOnDroid', etc keep this OFF. Whereas, If you download it from 'GitHub' or any other source which doesn't provide auto updates then turn this ON, so as to recieve update alerts"),
                      keyName: 'checkUpdate',
                      isThreeLine: true,
                      defaultValue: false,
                    ),
                    BoxSwitchTile(
                      ...
                      subtitle: const Text('Turn this on if you are not from India and having issues like getting only Indian Songs. You can even use a VPN'),
                      keyName: 'useProxy',
                      defaultValue: false,
                      isThreeLine: true,
                      onChanged: (bool val) {
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              final _controller = TextEditingController(text: settingsBox.get('proxyIp').toString());
                              final _controller2 = TextEditingController(text: settingsBox.get('proxyPort').toString());
                              return AlertDialog(
                                content: Column(
                                ...
                                actions: [
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      settingsBox.put('proxyIp', _controller.text.trim());
                                      settingsBox.put('proxyPort', int.parse(_controller2.text.trim()));
                                      Navigator.pop(context);
                                      setState(() {});
                                    },
                                    child: const Text(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        onTap: () {
                          SupaBase().getUpdate().then((Map value) {
                            if (compareVersion(value['LatestVersion'].toString(), appVersion!)) {
                              ShowSnackBar().showSnackBar(
                                context,
                                'Update Available!',
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Share.share('Hey! Check out this cool music player app: https://github.com/Sangwan5688/BlackHole');
                        },
                        dense: true,
                      ),
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('Even ₹1 makes me smile :)\nTap to donate or Long press to copy UPI ID'),
                        dense: true,
                        isThreeLine: true,
                        onTap: () {
                          const String upiUrl = 'upi://pay?pa=8570094149@okbizaxis&pn=BlackHole&mc=5732&aid=uGICAgIDn98OpSw&tr=BCR2DN6T37O6DB3Q';
                          launch(upiUrl);
                        },
                        onLongPress: () {
                          Clipboard.setData(const ClipboardData(text: 'ankit.sangwan.5688@oksbi'));
                          ShowSnackBar().showSnackBar(
                            context,
                            'UPI ID Copied!',
                          );
                        ...
                        trailing: TextButton(
                          ...
                          onPressed: () {
                            showDialog(
                                context: context,
                                builder: (BuildContext context) {
                                  return const Dialog(elevation: 10, backgroundColor: Colors.transparent, child: Image(image: AssetImage('assets/gpayQR.png')));
                                });
                          },
                          child: const Text(
                            'Show QR Code',
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch('https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dblackholeyoucantescape%40gmail.com%26subject%3DRegarding%2520Mobile%2520App');
                                              },
                                            ),
                                            const Text('Gmail'),
                                          ],
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch('https://instagram.com/sangwan5688');
                                              },
                                            ),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch('https://t.me/blackhole_official');
                                              },
                                            ),
                                            const Text('Channel'),
                                          ],
